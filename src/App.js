...
const store = createStore(olsApp, composeEnhancers(applyMiddleware(epicMiddleware)));
...
class App extends Component {
  ...
  render() {
    return (
      <Provider store={store}>
        <BrowserRouter>
          <div className="App">
            <MainNav openLogin={this.openLogin} openRegister={this.openRegister} openCards={this.openCards} center={true}/> {this.state.modal}
  ...
  openLogin() {
    ...
    this.setState({
      modal: <div className="modalBackground" onClick={(e) => {
          if (e.target === e.currentTarget) {
            this.close()
          }
        }}>
          <div className="modalWrapper"><LinkedLogin close={() => this.close()}/></div>
        </div>
    })
  ...
  openRegister() {
    ...
    this.setState({
      modal: <div className="modalBackground" onClick={(e) => {
          ...
          <div className="modalWrapper"><LinkedRegister close={() => this.close()}/></div>
        </div>
    })
  }
  openCards() {
