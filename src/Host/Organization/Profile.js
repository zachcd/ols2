    ...
    render() {
      return (
        <div className="Organization" id="{this.props.organization.url}">
          ...
          {(this.props.user && typeof this.props.organization.url !== "undefined" && typeof this.props.user.admin[this.props.organization.url] !== "undefined")
          && <adminNav url={this.props.organization.url}> </adminNav> }
